 ...
 *
 * Se um saco cheio de trigo pesa 60kg, e vazio 0.3kg, então a massa de trigo em
 * cada saco e de 59.7kg.
 *
 *
...
main(int argc, char** argv){
	...
	long double massa_grao = 3.2e-4,
	            massa_saco = 3.0e-1,
		    qtde_graos_saco = (6.0e1 - massa_saco) / massa_grao,
		    massa_graos = 0e0,
