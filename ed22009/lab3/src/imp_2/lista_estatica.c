/* $Id: lista_estatica.c,v 1.1 2009/09/27 22:45:56 raitech Exp raitech $ */
...
/* esta nova implementacao fica estranha, pois nao sei se de fato consegui ou
 * nao remover o elemento da lista
 *
 * o que retornar em caso de falha?!
 */
elem
